...
A way that costs can be brought down is to suspend and resume the Azure Fabric. The Terraform deployment includes a script and deploys this into an Azure Automation instance that has a schedule to suspend and resume the capacity at specified times.
