...
When run by the CI/CD pipeline the user will be the user of the agent. If no variable can be found, or the external script fails, then the value will set as "unknown".
...
The following image shows what the tags look like on the resource group for the Fabric deployment.
